    ...
    <div id="content" class="col-sm-9">
      ...
      <div class="row products-category">
        <div class="product-layout product-grid col-lg-3 col-md-3 col-sm-4 col-xs-12" v-for="product in products.data">
          <div class="product-thumb clearfix">
            <div class="image"><a :href="'http://shop.test:10/products/' + product.slug"><img :src="'http://shop.test:10/' + product.photos[0].path" alt="تی شرت کتان مردانه" title="تی شرت کتان مردانه" class="img-responsive" /></a></div>
            <div class="caption">
